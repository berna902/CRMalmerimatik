...
namespace Clientes.ServicioDatos2 {
    ...
    public interface ISrvDatos {
        ...
        Clientes.ServicioDatos2.AccionComercialData[] BusquedaAvanzadaAccionComercial(string comentario, string descripcion, string tipo, string estado, string username);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISrvDatos/BusquedaAvanzadaAccionComercial", ReplyAction="http://tempuri.org/ISrvDatos/BusquedaAvanzadaAccionComercialResponse")]
        System.Threading.Tasks.Task<Clientes.ServicioDatos2.AccionComercialData[]> BusquedaAvanzadaAccionComercialAsync(string comentario, string descripcion, string tipo, string estado, string username);
    }
    ...
    public partial class SrvDatosClient : System.ServiceModel.ClientBase<Clientes.ServicioDatos2.ISrvDatos>, Clientes.ServicioDatos2.ISrvDatos {
        ...
        public Clientes.ServicioDatos2.AccionComercialData[] BusquedaAvanzadaAccionComercial(string comentario, string descripcion, string tipo, string estado, string username) {
            return base.Channel.BusquedaAvanzadaAccionComercial(comentario, descripcion, tipo, estado, username);
        }
        
        public System.Threading.Tasks.Task<Clientes.ServicioDatos2.AccionComercialData[]> BusquedaAvanzadaAccionComercialAsync(string comentario, string descripcion, string tipo, string estado, string username) {
            return base.Channel.BusquedaAvanzadaAccionComercialAsync(comentario, descripcion, tipo, estado, username);
        }
    }
}
