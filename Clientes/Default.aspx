<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Clientes._Default" %>
                ...
                <LayoutTemplate>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <asp:Label CssClass="col-md-2 control-label" ID="UserNameLabel" runat="server" AssociatedControlID="UserName">Login:</asp:Label>
                            <div class="col-md-10">
