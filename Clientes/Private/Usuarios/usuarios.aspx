...
<asp:Content ID="Content3" ContentPlaceHolderID="central" runat="server">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-info" PostBackUrl="~/Private/Usuarios/Default.aspx" CausesValidation="False">Volver</asp:LinkButton>
        </div>
    </div>
</asp:Content>
